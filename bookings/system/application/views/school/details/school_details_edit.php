...
<fieldset>
    ...
    <p>
        ...
        <span style="background: none; position: relative;">
            <span style="background: none; position: absolute; left: 3px; top: 0px;">$</span>
            <input style="padding-left: 10px;" name="recurringPrice" pattern="^\d+(?:\.\d{0,2})$" value="<?php echo number_format($info->recurringPrice, 2) ?>"/>
        </span>
        <p class="hint">
            Please enter a dollar amount excluding GST (e.g 1.00)
        </p>
    </p>
    <p style="position: relative;">
        <label for="casualPrice">Casual Price</label>
        <span style="background: none; position: relative;">
            <span style="background: none; position: absolute; left: 3px; top: 0px;">$</span>
            <input style="padding-left: 10px;" name="casualPrice" pattern="^\d+(?:\.\d{0,2})$" value="<?php echo number_format($info->casualPrice, 2) ?>"/>
        </span>
        <p class="hint">
            Please enter a dollar amount excluding GST (e.g 1.00)
        </p>
