...
<p style="text-align:center">
	...
	?>
	<input onclick="return confirm('Are you sure you wish to make these recurring bookings?');" name="recurringBookings" type="submit" value="Make Recurring" />
	<input onclick="return confirm('Are you sure you wish to make these casual bookings?');" name="casualBookings" type="submit" value="Make Casual" />
</p>
</form>
