...
class School extends Controller
{
    ...
    */
    ...
    public function gradient($school_id = null, $colour = null)
    {
        if ($school_id == null) {
            $school_id = $this->uri->segment(3, $this->session->userdata('school_id'));
        }
        if ($colour == null) {
    ...
    public function _is_valid_colour($colour)
    {
        if ($colour == '') {
            return true;
        }
    ...
    public function _valid_columns($cols)
    {
        // Day: Periods / Rooms
        // Room: Periods / Days
    ...
    public function _makecol($colour)
    {
